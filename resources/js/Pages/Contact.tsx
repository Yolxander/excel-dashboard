...
import { Mail, Phone, MapPin, Clock, MessageSquare, Send, ArrowRight, CheckCircle } from "lucide-react"
...
export default function ContactPage() {
  ...
  const faqRef = useIntersectionObserver({ threshold: 0.3 })
  const supportRef = useIntersectionObserver({ threshold: 0.2 })

  return (
    <>
      <Head title="Contact - Xcel Dashboard" />
      <div className="bg-white p-4">
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg">
          ...
          <main className="container mx-auto px-4 py-12 md:py-20">
            ...
            >
              ...
              <p className={`text-lg md:text-xl text-gray-600 mb-12 max-w-2xl mx-auto transition-all duration-700 delay-400 ${
                ...
                We'd love to hear from you. Whether you have a question about our features, pricing, or need help with your dashboard, we're here to help.
              </p>
              ...
              <div className={`lg:w-1/2 space-y-8 transition-all duration-700 delay-400 ${
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-8">
                    We're here to help you get the most out of Xcel Dashboard. Reach out to us through any of these channels.
                  </p>
                </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-2">Get help with technical issues and general questions</p>
                        <a href="mailto:support@xceldashboard.com" className="text-blue-600 hover:text-blue-700 font-medium">
          ...
          >
            <div className={`text-center mb-12 transition-all duration-700 delay-200 ${
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Find quick answers to the most common questions about Xcel Dashboard.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 transition-all duration-700 delay-300 hover:shadow-xl hover:scale-105 ${
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-3">How do I get started with Xcel Dashboard?</h3>
                <p className="text-gray-600 text-sm">
                  Simply sign up for a free account, upload your Excel file, and choose from our pre-built templates or create your own custom dashboard. No coding required!
                </p>
              </div>
              ...
              <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 transition-all duration-700 delay-500 hover:shadow-xl hover:scale-105 ${
                ...
                <p className="text-gray-600 text-sm">
                  Absolutely! We use enterprise-grade encryption and security measures. Your data is encrypted both in transit and at rest, and we never share your information with third parties.
                </p>
              </div>
              ...
              <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 transition-all duration-700 delay-600 hover:shadow-xl hover:scale-105 ${
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-3">Can I share my dashboards with my team?</h3>
                <p className="text-gray-600 text-sm">
                  Yes! You can share dashboards via private links, export them as images or PDFs, or invite team members to collaborate directly on your dashboards.
                </p>
              </div>
              ...
              <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 transition-all duration-700 delay-700 hover:shadow-xl hover:scale-105 ${
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-3">Do you offer custom integrations?</h3>
                <p className="text-gray-600 text-sm">
                  We're constantly adding new integrations. Currently, we support Google Sheets, and we're working on integrations with OneDrive, Dropbox, and other popular platforms.
                </p>
              </div>
              ...
              <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 transition-all duration-700 delay-800 hover:shadow-xl hover:scale-105 ${
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-3">What if I need help with my dashboard?</h3>
                <p className="text-gray-600 text-sm">
                  Our support team is here to help! You can reach us via email, phone, or through our live chat. We typically respond within 24 hours during business days.
                </p>
              </div>
            </div>
          </section>
          ...
          <section
            ...
            ref={supportRef.ref}
            className={`container mx-auto px-4 py-12 md:py-20 transition-all duration-1000 ease-out ${
              supportRef.hasTriggered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
            <div className={`text-center mb-12 transition-all duration-700 delay-200 ${
              supportRef.hasTriggered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              <p className="text-sm font-semibold text-gray-700 mb-2">Need More Help?</p>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
                Additional Support Options
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We offer multiple ways to get the help you need, when you need it.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-100/50 transition-all duration-700 delay-700 hover:shadow-xl hover:scale-105 ${
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Learn from our step-by-step video guides and tutorials.
                </p>
                <Button variant="outline" className="w-full">
                  Watch Videos
                </Button>
          ...
          <section className="container mx-auto px-4 py-12 md:py-20 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of users who are already creating beautiful dashboards and making better decisions with their data.
            </p>
            <Link href="/login">
