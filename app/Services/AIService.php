...
class AIService
{
    ...
    {
        return "Analyze this Excel data and provide insights for a business dashboard.
...
Focus on identifying sales, revenue, commission, recruiter, and performance-related data. If the data doesn't contain these specific metrics, adapt the analysis to the available data types.";
    }
